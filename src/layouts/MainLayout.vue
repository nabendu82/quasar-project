<template>
  <q-layout view="lHr lpR fFf">
    ...
    <q-drawer show-if-above v-model="rightDrawerOpen" side="right" bordered>
      <q-input placeholder="Search Twitter" class="q-ma-md" outlined rounded dense>
      ...
      <q-list separator padding>
        <q-item class="q-pa-md">
          <q-item-section>
            ...
            <q-item-label caption>Primary line text. Lorem ipsum dolor sit amet, consectetur adipiscit elit.
            </q-item-label>
          </q-item-section>
        ...
        <q-item class="q-pa-md">
          <q-item-section>
            <q-item-label overline class="text-grey">Entertainment</q-item-label>
            <q-item-label class="text-weight-bold">Something did happened!</q-item-label>
        ...
        <q-item class="q-pa-md">
          <q-item-section>
            <q-item-label overline class="text-grey">Finance</q-item-label>
            <q-item-label class="text-weight-bold">What amazing happened!</q-item-label>
            <q-item-label caption>Third line text. Lorem ipsum dolor sit amet, consectetur adipiscit elit.
            </q-item-label>
          </q-item-section>
          <q-item-section side top>
            <q-item-label caption>5 min ago</q-item-label>
